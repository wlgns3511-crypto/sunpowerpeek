...
export const metadata: Metadata = {
  ...
  description: "Learn how SunPowerPeek collects, processes, and verifies solar energy potential and incentive data by state.",
};
  ...
  return (
    <article className="prose prose-slate max-w-3xl mx-auto">
      ...
      <p className="lead text-lg text-slate-600">
        SunPowerPeek is committed to providing accurate, comprehensive, and up-to-date data.
        This page explains how we collect, process, and verify our information.
      </p>

      <h2>Data Sources</h2>
      <p>
        Our data is sourced from authoritative, publicly available databases including: <strong>NREL Solar Resource Data, DSIRE Incentive Database</strong>.
