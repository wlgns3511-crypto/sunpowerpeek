...
export const metadata: Metadata = {
  title: "Disclaimer",
  description: "Disclaimer and limitations of liability for SunPowerPeek.",
...
export default function DisclaimerPage() {
  return (
    <article className="prose prose-slate max-w-3xl mx-auto">
      ...
      <p>
        The information provided on SunPowerPeek is for general informational and educational purposes only. While we
      ...
      <p>
        Data displayed on SunPowerPeek is sourced from publicly available databases and third-party sources. While we
      ...
      <p>
        SunPowerPeek displays third-party advertisements through Google AdSense and other ad networks. These advertisements
        are provided by third parties and do not imply endorsement by SunPowerPeek. We are not responsible for the content
      ...
      <p>
        In no event shall SunPowerPeek, its owners, operators, or contributors be liable for any direct, indirect,
      ...
      <p>
        ...
        <a href="/contact" className="text-orange-700 hover:underline">Contact page</a>.
      </p>
    </article>
  );
}
